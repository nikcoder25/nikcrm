...
export const clientsCsv = (clients) => toCsv(clients, [
  ...
  { header: "Start Date", value: (c) => (c.start_date ? String(c.start_date).slice(0, 10) : "") },
  { header: "End Date", value: (c) => (c.end_date ? String(c.end_date).slice(0, 10) : "") },
  { header: "Order Details", value: (c) => c.order_details || "" },
  { header: "Blog Status", value: (c) => c.blog_status || "" },
