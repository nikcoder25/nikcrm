...
/* ---------------- Activity log (audit trail) ----------------
   Who changed what (writes to the `activity` table via logActivity in the
   API). Distinct from Activity.jsx, the per-client touchpoint timeline. */
...
export default function ActivityLog({ items, clients }) {
  return (
    <Panel>
